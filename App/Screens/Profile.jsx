...
const Profile = () => {
  ...
  const saveEditedValue = async () => {
    try {
      ...
      const request = await client.post(
        `/psychologist/updateProfile/${user.user?._id}`,
        {
  ...
  const changePass = async () => {
    try {
      ...
      const request = await client.post(
        `/psychologist/updatePassword/${user.user?._id}`,
        {
    ...
    try {
      ...
      if (!result.canceled) {
        ...
        const res = await client.post(
          `/psychologist/changeProfilePicture/${user.user?._id}`,
          data,
          {
            headers: {
              ...
              >
                <View style={styles.fieldItem}>
                  ...
                  <Text style={styles.fieldValue}>
                    {checkField(field, user.user[field])}
                  </Text>
